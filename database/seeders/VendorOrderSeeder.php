...
class VendorOrderSeeder extends Seeder
{
    public function run()
    {
        ...
        $carProducts = [
            ['name' => 'Toyota Corolla', 'price' => 250000],
            ['name' => 'Honda Civic', 'price' => 240000],
            ['name' => 'Ford F-150', 'price' => 350000],
            ['name' => 'BMW 3 Series', 'price' => 420000],
            ['name' => 'Mercedes-Benz C-Class', 'price' => 450000],
            ['name' => 'Audi A4', 'price' => 410000],
            ['name' => 'Volkswagen Golf', 'price' => 230000],
            ['name' => 'Hyundai Sonata', 'price' => 220000],
            ['name' => 'Kia K5', 'price' => 210000],
            ['name' => 'Mazda 3', 'price' => 200000],
        ];
