...
@section('content')
    <div class="content-card">
        ...
        <div id="supplier-orders" class="tab-content{{ !$vendorTabActive ? ' active' : '' }}">
            <h3 style="color: var(--secondary); font-size: 1.5rem; margin-bottom: 1rem; font-weight:bold;"><i class="fas fa-truck"></i> Supplier Orders</h3>
            <!-- Summary Cards -->
            <div style="display: flex; gap: 2rem; margin-bottom: 2rem; flex-wrap: wrap;">
                ...
                <div class="orders-summary-card declined">
                    <div style="font-size: 1.2rem; color: #b71c1c; font-weight: 700;">{{ $supplierOrders->where('status','declined')->count() }}</div>
                    <div style="font-size: 0.98rem; color: #555;">Declined</div>
                </div>
            </div>
            <!-- Orders Table -->
        ...
        <div id="vendor-orders" class="tab-content{{ $vendorTabActive ? ' active' : '' }}" style="display: none;">
            <h3 style="color: var(--secondary); font-size: 1.5rem; margin-bottom: 1rem; font-weight:bold;"><i class="fas fa-truck"></i> Vendor Orders Management</h3>
            <!-- Vendor Orders Summary Cards -->
            <div style="display: flex; gap: 2rem; margin-bottom: 2rem; flex-wrap: wrap;">
                <div class="orders-summary-card fulfilled">
                    <div style="font-size: 1.2rem; color: #27ae60; font-weight: 700;">{{ $vendorOrders->where('status','fulfilled')->count() }}</div>
                    <div style="font-size: 0.98rem; color: #555;">Fulfilled</div>
                </div>
                <div class="orders-summary-card cancelled">
                    <div style="font-size: 1.2rem; color: #b71c1c; font-weight: 700;">{{ $vendorOrders->where('status','cancelled')->count() }}</div>
                    <div style="font-size: 0.98rem; color: #555;">Cancelled</div>
                </div>
                <div class="orders-summary-card total">
                    <div style="font-size: 1.2rem; color: var(--primary); font-weight: 700;">{{ $vendorOrders->count() }}</div>
                    <div style="font-size: 0.98rem; color: #555;">Total</div>
                </div>
            </div>
