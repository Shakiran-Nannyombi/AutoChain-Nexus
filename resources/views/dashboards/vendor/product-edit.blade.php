...
<div class="content-card">
    ...
    <form method="POST" action="{{ route('vendor.products.update', $product->id) }}" style="max-width: 500px;" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            @if($product->image_url)
                <div style="margin-bottom:0.5rem;"><img src="{{ asset($product->image_url) }}" alt="Current Image" style="max-width:100px; max-height:80px;"></div>
            @endif
