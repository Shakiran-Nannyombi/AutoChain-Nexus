    ...
    <div class="chat-main" style="flex: 1; display: flex; flex-direction: column; background: #f8fafc;">
      ...
      <div id="chat-messages-area" class="chat-messages" style="flex: 1; overflow-y: auto; padding: 2rem 2rem 1rem 2rem; background: #f8fafc; border-radius: 0 0 18px 18px;">
        <div id="welcome-message" style="margin-bottom: 2.5rem; text-align: center;">
          ...
          <h1 style="color: #166534; font-size: 2.5rem; font-weight: 700; margin-bottom: 1.2rem; text-align: center;">Welcome to Retailer Chat</h1>
          <div style="font-size: 1.25rem; color: #222; margin-bottom: 2.2rem; max-width: 520px; margin-left: auto; margin-right: auto; text-align: center;">
            Here you can communicate directly with vendor, customer, or admin. Select a user from the list on the left to view your conversation or start a new chat.
          </div>
          ...
          <div class="demo-chat" data-role="vendor" style="display:none;">
            <div style="display: flex; align-items: flex-end; margin-bottom: 1.2rem;">
              ...
              <div style="background: #e3f0ff; color: #166534; border-radius: 18px; padding: 1rem 1.3rem; font-size: 1.08rem; max-width: 70vw; min-width: 120px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                Hi Retailer, do you have the new product catalog?
                <div style="font-size: 0.95rem; color: #6b7280; margin-top: 0.5rem; text-align: right;">Vendor, 14:05</div>
              </div>
            </div>
            <div style="display: flex; align-items: flex-end; justify-content: flex-end; margin-bottom: 1.2rem;">
              ...
              <div style="margin-left: 10px;"><span class="avatar" style="width: 38px; height: 38px; border-radius: 50%; background: #e0e7ff; color: #3730a3; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.2rem;">R</span></div>
            </div>
          </div>
          <!-- Demo chat for Customer -->
          <div class="demo-chat" data-role="customer" style="display:none;">
            <div style="display: flex; align-items: flex-end; margin-bottom: 1.2rem;">
              <div style="margin-right: 10px;"><span class="avatar" style="width: 38px; height: 38px; border-radius: 50%; background: #fca5a5; color: #991b1b; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.2rem;">C</span></div>
              <div style="background: #fef2f2; color: #991b1b; border-radius: 18px; padding: 1rem 1.3rem; font-size: 1.08rem; max-width: 70vw; min-width: 120px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                Hi Retailer, I’d like to place a new order for 10 units.
                <div style="font-size: 0.95rem; color: #991b1b; margin-top: 0.5rem; text-align: right;">Customer, 15:10</div>
              </div>
            </div>
            <div style="display: flex; align-items: flex-end; justify-content: flex-end; margin-bottom: 1.2rem;">
              <div style="background: #2563eb; color: #fff; border-radius: 18px; padding: 1rem 1.3rem; font-size: 1.08rem; max-width: 70vw; min-width: 120px; box-shadow: 0 2px 8px rgba(0,0,0,0.03);">
                Order received! We’ll process it right away.
                <div style="font-size: 0.95rem; color: #dbeafe; margin-top: 0.5rem; text-align: right;">You, 15:11</div>
              </div>
              <div style="margin-left: 10px;"><span class="avatar" style="width: 38px; height: 38px; border-radius: 50%; background: #e0e7ff; color: #3730a3; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 1.2rem;">R</span></div>
            </div>
          </div>
