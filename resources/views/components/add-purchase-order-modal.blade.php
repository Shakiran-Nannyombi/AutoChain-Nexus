        ...
        <div class="mt-2 text-center text-gray-800">
            <form action="{{ route('purchase-orders.store') }}" method="POST">
                ...
                <div class="flex justify-end space-x-2 mt-4">
                    <button type="button" id="cancelAddPurchaseOrder" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300">Cancel</button>
                    <button type="submit" class="bg-primary hover:bg-primary-dark text-white px-4 py-2 rounded-md">Save Purchase Order</button>
                </div>
            </form>
        </div>
    </div>
