...
@section('headerTitle', 'Reports & Analytics')
            ...
            @forelse($savedReports ?? [] as $report)
                <div class="bg-white p-4 rounded-lg shadow">
                    <div class="flex justify-between items-start">
                        ...
                        <div class="flex space-x-2">
                            <x-ui.button variant="ghost" class="text-primary hover:text-primary-dark">
                            ...
                            <x-ui.button variant="ghost" class="text-red-600 hover:text-red-900">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="mt-4">
                        <div class="flex items-center text-sm text-gray-500">
                            ...
                            <span>Last run: {{ $report->last_run->format('M d, Y H:i') }}</span>
                        </div>
                        <div class="flex items-center text-sm text-gray-500 mt-1">
                            <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2m-9 0V3h10v2m-6 0h.01M16 16l-3-3m0 0l-3 3m3-3v6"/>
                            </svg>
